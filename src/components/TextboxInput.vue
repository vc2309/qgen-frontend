<template>
  <div class="h-full mx-auto p-4 from-slate-950 rounded-md text-black text-lg justify-items-center ">
    ...
    <input v-model="answer[currConversation]" class="p-2 mt-4 w-11/12 rounded-md border border-solid text-left placeholder-gray-700" placeholder="Enter the answer to the question here..."/>
  </div>
...
export default {
  ...
  methods: {
    ...
    onSubmit(){
      emitter.emit("submit", {cnt : this.input, ans : this.answer});
    },
